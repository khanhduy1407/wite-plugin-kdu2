...
import transpile from 'kdu-template-es2015-compiler'
...
function actuallyCompile(
  ...
  if (errors && errors.length) {
    ...
    // transpile code with kdu-template-es2015-compiler, which is a forked
    ...
    if (!isProduction) {
      // mark with stripped (this enables Kdu to use correct runtime proxy
      // detection)
